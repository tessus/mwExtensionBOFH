...
class BOFH
{
	...
	public static function functionBOFH( $parser, $value )
	{
		...
		$output = '<table style="'.$width.'border: 4px; border-spacing: 0px; border-color-top: #afafaf; border-color-left: #afafaf; border-color-right: #444444; border-color-bottom: #444444; border-style: outset;">';
